...
This Software Engineering Analyst demonstrates technical skills and project experience, but the resume has significant weaknesses. The resume shows extremely limited professional work experience—only 5 months of actual Software Engineering Analyst experience (02/2017 to 07/2017) with most content focused on student projects and academic work. Additionally, while the candidate mentions achievements like increasing artisan income by 150%, these are from student projects rather than professional accomplishments, making it difficult to assess real-world competency. The resume lacks quantifiable professional achievements and specific examples of software engineering impact in a business environment. The education section also shows a Chemical Engineering degree (6.7/10 GPA) which is unrelated to software engineering, raising questions about technical foundation.
